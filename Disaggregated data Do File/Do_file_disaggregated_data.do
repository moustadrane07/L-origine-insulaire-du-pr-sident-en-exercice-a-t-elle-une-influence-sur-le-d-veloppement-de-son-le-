...
Favoritisme insulaire aux Comores - Adaptation de Franck & Rainer (2012)
-------------------------------------------------------------------------------
SOMMAIRE
   0.  Chemins et initialisation
   1.  Calendrier des dirigeants (1976-2022, île au pouvoir)
   2.  Programmes de construction de CoIL (build_coil, build_coil_window,
       build_coil_contemp, build_mandat_dominant, starfmt)
   3.  Construction des 4 échantillons (Principal, Femmes, Hommes, Mortalité)
   ...
   7.  Tableau 4 : Hétérogénéité insulaire par interaction
   8.  Tableau 4 (suite) : Tests d'égalité des coefficients CoIL x île
   9.  Tableau 5 : Hétérogénéité par mandat présidentiel
   10. Tableau 8 : Test de falsification
   11. Tableau 6 : Robustesse aux effets de sélection
   12. Tableau 7 : Effet différentiel pré/post réforme (2001-2002)
   13. Nettoyage - suppression des fichiers obsolètes (TableA2.rtf)
       Récapitulatif final (liste des fichiers exportés)

Fichiers exportés dans $tables : Table1.rtf à Table8.rtf (numérotation continue,
sans saut ni suffixe "bis" ; Table7_PrePostReforme.rtf pour le Tableau 7).
==============================================================================*/
clear all
set more off
set varabbrev off
...
esttab TI_1 TI_2 TI_3 TI_4 using "$tables\Table4.rtf", replace ///
    ...
    mtitles("Éducation partielle" "Éducation complète" "Alphabétisation" "Décès infantile") ///
    stats(N r2, fmt(%12.0fc %9.3f) labels("Observations" "R²")) ///
    title("Tableau 4 : Hétérogénéité insulaire par interaction — spécification poolée") ///
...
*=== 9. TABLEAU 5 : HÉTÉROGÉNÉITÉ PAR MANDAT PRÉSIDENTIEL =====================
* Un seul tableau, pas de sous-échantillon, 4 variables dépendantes.
...
*=== 13. NETTOYAGE - SUPPRESSION DES FICHIERS OBSOLÈTES =======================
* TableA2.rtf provient d'une ancienne version du do-file : son contenu
* (statistiques descriptives) est désormais exporté sous le nom Table1.rtf
* (section 4). C'est un doublon obsolète, à supprimer.
